# -*- coding: utf-8 -*-
#
# Bruces documentation build configuration file, created by
...
project = u'Sphinx HTML Multiple Versions'
copyright = u'2015, Francis Lacroix'
...
htmlhelp_basename = 'Sphinxhtmlmultiversionsdoc'
